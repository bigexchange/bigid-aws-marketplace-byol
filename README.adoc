...
image:https://raw.githubusercontent.com/bigexchange/bigid-aws-marketplace-byol/master/images/ouput.png[]

Browse the the IP Address and login using the BigID App Username and BigID App Passwords. +

image:https://github.com/bigexchange/bigid-aws-marketplace-byol/blob/master/images/bigid.jpg?raw=true
